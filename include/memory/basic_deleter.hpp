...
*/
#ifndef __SQUADS_BASIC_DELETER_H__
#define __SQUADS_BASIC_DELETER_H__
    ...
    namespace memory {
        ...
        public:
			...
			void operator()(value_type* pP) noexcept {
				static_assert(!squads::is_void<value_type>::value, "can't delete pP to incomplete type");
        ...
        public:
			...
			template<typename U>
			using remove_cv_type = typename squads::remove_cv<U>::type;
